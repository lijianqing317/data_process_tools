...
def cut_json(file_tuple):
    ...
    for index_object in range(len(cut_one_img)):
        ...
        new_name_img = '1_{}_{}_{}.jpg'.format(mid_point[index_object][0],mid_point[index_object][1],index_object)
        new_name_json = '1_{}_{}_{}.json'.format(mid_point[index_object][0],mid_point[index_object][1],index_object)
        ...
        save_new_img(img_np,new_name_img,x_min,y_min,x_max,y_max,out_p_im,imgw,imgh)
        #生成新的json文件
...
def def_new_json(json_data,crop_szie_w,crop_size_h,new_name,shapes_img,out_p,new_name_img):
    new_json = {}
    new_json['flags'] = None#json_data['flags']
    new_json['imageData'] = None
    new_json['imageDepth'] = 3 #json_data['imageDepth']
...
if __name__ == '__main__':
    # root_path = '/media/lijq/f373fb19-ec6a-4a1c-96e5-3f2013f3f5c6/AD_MODIFY/merge_dcg'
    #
    # out_path_root = root_path[:root_path.rindex(os.sep)+1]
    out_path = r'D:\work\2022\rg261'
    #out_path = '{}/crop'.format(out_path_root)
    if not os.path.exists(out_path):
        os.makedirs(out_path)
    # json_source='{}/jsons'.format(root_path)
    # imgs_path = '{}/imgs'.format(root_path)r
    json_source=r'D:\work\2022\rg26'
    imgs_path = r'D:\work\2022\rg26'
    cut_label = ['pengshang']
    # cut_label = ['aokeng', 'baisezaodian', 'cashang', 'daowen', 'daowenxian', 'guashang', 'heidian', 'pengshang', 'shahenyin', 'tabian', 'yise', 'yiwu']
    #cut_label = ['daowen', 'aotuhen', 'shahenyin', 'tabian', '3ddaowen', 'guashang', 'pengshang', 'yise', 'heidian']#['aotuhen', 'daowen', 'yise', 'tabian', 'guashang', '3Daohen', 'shahenyin', 'penshabujun']#['yise', 'baisezaodian', 'guashang', 'pengshang', 'aokeng', 'heidian', 'daowen', 'tabian', 'shahenyin']#['pengshang', 'heidian', 'guashang', 'yiwu', 'yise', 'aokeng', 'tabian', 'daowen', 'shahenyin', 'baisezaodian']#['3ddaowen', 'aokeng', 'aotuhen', 'baisezaodian', 'daowen', 'daowenxian', 'guashang', 'heidian', 'pengshabujun', 'pengshang', 'shahenyin', 'tabian', 'yinglihen', 'yise', 'yiwu']

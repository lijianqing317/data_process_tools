...
if __name__ == "__main__":
    annotation_root_path = '/media/lijq/f373fb19-ec6a-4a1c-96e5-3f2013f3f5c6/R/origin'
    out_coco_root_path = '/media/lijq/f373fb19-ec6a-4a1c-96e5-3f2013f3f5c6/R'
    Select_data(annotation_root_path,out_coco_root_path)#过滤xml与img不符合情况
    annotation_root_path = r'/media/lijq/f373fb19-ec6a-4a1c-96e5-3f2013f3f5c6/R/origin'
    out_coco_root_path = r'/media/lijq/f373fb19-ec6a-4a1c-96e5-3f2013f3f5c6/R'
    img_jsons=os.path.join(annotation_root_path,'jsons1')
    process_nums = 8
    result_write = os.path.join(out_coco_root_path,'label.txt')
    xml2json =Xml2Labelme(annotation_root_path,img_jsons,result_write,process_nums)
    # # #
    # cut_label = ['pengshang', 'heidian', 'guashang', 'yiwu', 'yise', 'aokeng', 'tabian', 'daowen', 'shahenyin', 'baisezaodian']
    # cut_w,cut_h=500,8500
    ...
    #
    #2coco
    # labelme_json=glob.glob('/home/lijq/data/R/310/jsons/*.json')
    # coco_path = os.path.join('/home/lijq/data/R/310','instances_test2017.json')
    # labelme2coco(labelme_json,coco_path)
    #
